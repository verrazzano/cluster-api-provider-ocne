...
replace (
	github.com/ajeddeloh/go-json => github.com/coreos/go-json v0.0.0-20220325222439-31b2177291ae
	github.com/coredns/corefile-migration => github.com/coredns/corefile-migration v1.0.18
