...
import (
	...
	runtimewebhooks "github.com/verrazzano/cluster-api-provider-ocne/internal/webhooks/runtime"
	"github.com/verrazzano/cluster-api-provider-ocne/util/kubeconfig"
	"github.com/verrazzano/cluster-api-provider-ocne/version"
	"github.com/verrazzano/cluster-api-provider-ocne/webhooks"
...
func newEnvironment(uncachedObjs ...client.Object) *Environment {
	...
	env := &envtest.Environment{
		...
		CRDDirectoryPaths: []string{
			...
			filepath.Join(root, "controlplane", "ocne", "config", "crd", "bases"),
			filepath.Join(root, "bootstrap", "ocne", "config", "crd", "bases"),
		},
