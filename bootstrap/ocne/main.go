...
func InitFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&tokenTTL, "bootstrap-token-ttl", ocnebootstrapcontrollers.DefaultTokenTTL,
...
func main() {
	...
	restConfig.UserAgent = remote.DefaultClusterAPIUserAgent("cluster-api-provider-ocne-bootstrap-manager")
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:           "ocne-bootstrap-manager-leader-election-capi",
