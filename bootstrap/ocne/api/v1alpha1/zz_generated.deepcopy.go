...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AddonInstall) DeepCopyInto(out *AddonInstall) {
	*out = *in
	if in.Arguments != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddonInstall.
func (in *AddonInstall) DeepCopy() *AddonInstall {
	if in == nil {
		return nil
	}
	out := new(AddonInstall)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ImageConfigurationSpec) DeepCopy() *ImageConfigurationSpec {
	...
	out := new(ImageConfigurationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OCNEConfigSpec) DeepCopyInto(out *OCNEConfigSpec) {
	*out = *in
	...
	if in.PreOCNECommands != nil {
		in, out := &in.PreOCNECommands, &out.PreOCNECommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.PostOCNECommands != nil {
		in, out := &in.PostOCNECommands, &out.PostOCNECommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Users != nil {
	...
	if in.AddOnInstall != nil {
		in, out := &in.AddOnInstall, &out.AddOnInstall
		*out = make([]AddonInstall, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OCNEConfigTemplateList) DeepCopyInto(out *OCNEConfigTemplateList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]OCNEConfigTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OCNEConfigTemplateList) DeepCopy() *OCNEConfigTemplateList {
	...
	out := new(OCNEConfigTemplateList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OCNEConfigTemplateResource) DeepCopy() *OCNEConfigTemplateResource {
	...
	out := new(OCNEConfigTemplateResource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OCNEConfigTemplateSpec) DeepCopy() *OCNEConfigTemplateSpec {
	...
	out := new(OCNEConfigTemplateSpec)
	in.DeepCopyInto(out)
	return out
}
