...
var (
	...
	ocneControlPlaneConcurrency int
...
func InitFlags(fs *pflag.FlagSet) {
	...
	fs.IntVar(&ocneControlPlaneConcurrency, "ocnecontrolplane-concurrency", 10,
		"Number of ocne control planes to process simultaneously")
...
func main() {
	...
	restConfig.UserAgent = remote.DefaultClusterAPIUserAgent("cluster-api-provider-ocne-control-plane-manager")
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:           "ocne-control-plane-manager-leader-election-capi",
