...
func MatchesMachineSpec(infraConfigs map[string]*unstructured.Unstructured, machineConfigs map[string]*bootstrapv1.OcneConfig, kcp *controlplanev1.OcneControlPlane) func(machine *clusterv1.Machine) bool {
	return collections.And(
		...
		MatchesOcneBootstrapConfig(machineConfigs, kcp),
...
func MatchesTemplateClonedFrom(infraConfigs map[string]*unstructured.Unstructured, kcp *controlplanev1.OcneControlPlane) collections.Func {
...
func MatchesOcneBootstrapConfig(machineConfigs map[string]*bootstrapv1.OcneConfig, kcp *controlplanev1.OcneControlPlane) collections.Func {
	return func(machine *clusterv1.Machine) bool {
		if machine == nil {
			return false
		}
...
func matchClusterConfiguration(kcp *controlplanev1.OcneControlPlane, machine *clusterv1.Machine) bool {
	...
	kcpLocalClusterConfiguration := kcp.Spec.OcneConfigSpec.ClusterConfiguration
...
func matchInitOrJoinConfiguration(machineConfig *bootstrapv1.OcneConfig, kcp *controlplanev1.OcneControlPlane) bool {
	...
	bootstrapv1.DefaultOcneConfigSpec(kcpConfig)
...
func getAdjustedKcpConfig(kcp *controlplanev1.OcneControlPlane, machineConfig *bootstrapv1.OcneConfig) *bootstrapv1.OcneConfigSpec {
	kcpConfig := kcp.Spec.OcneConfigSpec.DeepCopy()
...
func cleanupConfigFields(kcpConfig *bootstrapv1.OcneConfigSpec, machineConfig *bootstrapv1.OcneConfig) {
...
func matchMachineTemplateMetadata(kcp *controlplanev1.OcneControlPlane, obj client.Object) bool {
