...
func (in *ModuleAddons) DeepCopyInto(out *ModuleAddons) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleAddons.
func (in *ModuleAddons) DeepCopy() *ModuleAddons {
	if in == nil {
		return nil
	}
	out := new(ModuleAddons)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OCNEControlPlaneSpec) DeepCopyInto(out *OCNEControlPlaneSpec) {
	*out = *in
	...
	if in.Addons != nil {
		...
		*out = make([]ModuleAddons, len(*in))
		copy(*out, *in)
	}
	if in.OCNEModuleOperator != nil {
		in, out := &in.OCNEModuleOperator, &out.OCNEModuleOperator
		*out = new(ModuleOperator)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OCNEImageMeta) DeepCopyInto(out *OCNEImageMeta) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OCNEImageMeta.
func (in *OCNEImageMeta) DeepCopy() *OCNEImageMeta {
	if in == nil {
		return nil
	}
	out := new(OCNEImageMeta)
