...
func (in *OCNEControlPlaneSpec) DeepCopyInto(out *OCNEControlPlaneSpec) {
	*out = *in
	...
	if in.VerrazzanoPlatformOperator != nil {
		...
		*out = new(VerrazzanoPlatformOperator)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerrazzanoPlatformOperator) DeepCopyInto(out *VerrazzanoPlatformOperator) {
	*out = *in
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(ImageMeta)
...
func (in *VerrazzanoPlatformOperator) DeepCopy() *VerrazzanoPlatformOperator {
	if in == nil {
		return nil
	}
	out := new(VerrazzanoPlatformOperator)
